...
import { toggleAnimation, toggleLayout, toggleNavbar, toggleRTL, toggleSemidark, toggleTheme } from '../../store/theme';
            ...
            >
                ...
                <div className="overflow-y-auto overflow-x-hidden perfect-scrollbar h-full">
                    ...
                    <div className="border border-dashed border-white-light dark:border-[#1b2e4b] rounded-md mb-3 p-3">
                        ...
                        <div className="flex gap-2 mt-3">
                            <button type="button" className={`btn flex-auto`} onClick={() => dispatch(toggleRTL('ltr'))}>
                                LTR
                            </button>

                            <button type="button" className={`btn flex-auto`} onClick={() => dispatch(toggleRTL('rtl'))}>
                                RTL
                            </button>
                        </div>
                    </div>
